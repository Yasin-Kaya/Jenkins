[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-c66648af7eb3fe8bc4f294546bfd86ef473780cde1dea487d3c4ff354943c9ae.svg)](https://classroom.github.com/online_ide?assignment_repo_id=9691599&assignment_repo_type=AssignmentRepo)
# Project-01: Jenkins Pipeline for Web Page Application (Postgresql-Nodejs-React) deployed on EC2's with Ansible and Docker
...
- Codes written by developers should be pulled from Kaya-Y Repo into the Jenkins server and sent them to the EC2's from here with Ansible.
...
In the architecture, you can configure your architecture with these conditions,
  ...
  - `given_files` file should be pulled from Github Repo at the beginning. Then these files should be copy to related folders.
...
|----given_files (folder)     # Given to the team (Postgresql, Nodejs and React files)
